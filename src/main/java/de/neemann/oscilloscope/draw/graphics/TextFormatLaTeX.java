...
import de.neemann.oscilloscope.draw.graphics.text.ParseException;
import de.neemann.oscilloscope.draw.graphics.text.Parser;
import de.neemann.oscilloscope.draw.graphics.text.formatter.LaTeXFormatter;
import de.neemann.oscilloscope.draw.graphics.text.text.Decorate;
import de.neemann.oscilloscope.draw.graphics.text.text.Text;
...
public class TextFormatLaTeX implements GraphicSVG.TextStyle {
    ...
    public String format(String text, Style style) {
        try {
            ...
            if (style.getFontStyle() == Font.ITALIC || pinStyleInMathMode)
                t = Decorate.math(t);
